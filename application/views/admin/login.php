...
<head>
  ...
  <title>SISFO Kepegawaian | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
      <a href="<?php echo site_url(); ?>"><img src="<?php echo base_url('assets/image/logo/logo.png')?> "></a>
  </div>
  <!-- /.login-logo -->
  <?php 
  $data = $this->session->userdata('notif');
  if (isset($data)){ ?>
    <div class="alert alert-danger fade in">
        <a href="#" class="close" data-dismiss="alert">&times;</a>
        <strong>Warning!</strong> <?php echo $this->session->userdata('notif') ?>
    </div>
  <?php } ?>
