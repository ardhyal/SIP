...
<head>
  ...
  <title>SISFO Kepegawaian | Control Panel</title>
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li <?php echo $active == "dashboard" ? 'class="active"' : '' ?>>
          <a href="<?php echo site_url('dashboard'); ?>"><i class="fa fa-bar-chart"></i> <span>Dashboard</span></a>
        </li>
        <li <?php echo $active == "Dataform" ? 'class="active"' : '' ?>>
          <a href="<?php echo site_url('dataform'); ?>"><i class="fa fa-sign-in"></i> <span>Data Form</span></a>
        </li>
        <li <?php echo $active == "video" ? 'class="active"' : '' ?>>
          <a href="<?php echo site_url('video'); ?>"><i class="fa fa-video-camera"></i> <span>Video</span></a>
        </li>
